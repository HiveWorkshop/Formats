    ...
    private function _read() {
        ...
        switch ($this->elementType()) {
            ...
            case 16:
                ...
                break;
            default:
                $this->_m_data = new Error("Unexpected element type", $this->_io, $this, $this->_root);
                break;
        }
    }
...
class Error extends \Kaitai\Struct\Struct {
    public function __construct(string $errorString, \Kaitai\Struct\Stream $_io, \Kaitai\Struct\Struct $_parent = null, Wtg $_root = null) {
        parent::__construct($_io, $_parent, $_root);
        $this->_m_errorString = $errorString;
        $this->_read();
    }

    private function _read() {
        $this->_m_error = $this->_io->ensureFixedContents("\x65\x72\x72\x6F\x72\x5F\x73\x74\x72\x69\x6E\x67");
    }
    protected $_m_error;
    protected $_m_errorString;
    public function error() { return $this->_m_error; }
    public function errorString() { return $this->_m_errorString; }
}
    ...
    private function _read() {
        switch ($this->name()) {
            case "DestroyEffectBJ":
                $this->_m__raw_body = $this->_io->readBytes(0);
                $io = new \Kaitai\Struct\Stream($this->_m__raw_body);
                $this->_m_body = new Parameters(1, $io, $this, $this->_root);
                break;
            case "SaveAbilityHandleBJ":
                $this->_m__raw_body = $this->_io->readBytes(0);
                $io = new \Kaitai\Struct\Stream($this->_m__raw_body);
                $this->_m_body = new Parameters(4, $io, $this, $this->_root);
                break;
            ...
            case "MultiboardMinimizeBJ":
                $this->_m__raw_body = $this->_io->readBytes(0);
                $io = new \Kaitai\Struct\Stream($this->_m__raw_body);
                $this->_m_body = new Parameters(2, $io, $this, $this->_root);
                break;
            ...
            case "BlzSetAbilityResearchTooltip":
                $this->_m__raw_body = $this->_io->readBytes(0);
                $io = new \Kaitai\Struct\Stream($this->_m__raw_body);
                $this->_m_body = new Parameters(3, $io, $this, $this->_root);
                break;
            ...
            case "IsFogEnabled":
                $this->_m__raw_body = $this->_io->readBytes(0);
                $io = new \Kaitai\Struct\Stream($this->_m__raw_body);
                $this->_m_body = new Parameters(0, $io, $this, $this->_root);
                break;
            ...
            case "MultiboardSetTitleTextColorBJ":
                $this->_m__raw_body = $this->_io->readBytes(0);
                $io = new \Kaitai\Struct\Stream($this->_m__raw_body);
                $this->_m_body = new Parameters(5, $io, $this, $this->_root);
                break;
            case "SetVariable":
                $this->_m__raw_body = $this->_io->readBytes(0);
                $io = new \Kaitai\Struct\Stream($this->_m__raw_body);
            ...
            case "CreateUbersplatBJ":
                $this->_m__raw_body = $this->_io->readBytes(0);
                $io = new \Kaitai\Struct\Stream($this->_m__raw_body);
                $this->_m_body = new Parameters(8, $io, $this, $this->_root);
                break;
            case "SaveGame":
                $this->_m__raw_body = $this->_io->readBytes(0);
                $io = new \Kaitai\Struct\Stream($this->_m__raw_body);
            ...
            case "SetUnitLookAt":
                $this->_m__raw_body = $this->_io->readBytes(0);
                $io = new \Kaitai\Struct\Stream($this->_m__raw_body);
                $this->_m_body = new Parameters(6, $io, $this, $this->_root);
                break;
            case "EnableTrigger":
                $this->_m__raw_body = $this->_io->readBytes(0);
                $io = new \Kaitai\Struct\Stream($this->_m__raw_body);
            ...
            case "CinematicFilterGenericBJ":
                $this->_m__raw_body = $this->_io->readBytes(0);
                $io = new \Kaitai\Struct\Stream($this->_m__raw_body);
                $this->_m_body = new Parameters(11, $io, $this, $this->_root);
                break;
            ...
            case "UnitDamagePointLoc":
                $this->_m__raw_body = $this->_io->readBytes(0);
                $io = new \Kaitai\Struct\Stream($this->_m__raw_body);
                $this->_m_body = new Parameters(7, $io, $this, $this->_root);
                break;
            ...
            case "TransmissionFromUnitTypeWithNameBJ":
                $this->_m__raw_body = $this->_io->readBytes(0);
                $io = new \Kaitai\Struct\Stream($this->_m__raw_body);
                $this->_m_body = new Parameters(10, $io, $this, $this->_root);
                break;
            ...
            default:
                $this->_m__raw_body = $this->_io->readBytes(0);
                $io = new \Kaitai\Struct\Stream($this->_m__raw_body);
                $this->_m_body = new Error("Unexpected function name", $io, $this, $this->_root);
                break;
        }
    }
    protected $_m_body;
